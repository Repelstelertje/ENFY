...
<html lang="nl">
    <head>
        ...
        <meta name="description" content="Bekijk het cookiebeleid van e-notifyer.nl om te zien hoe we cookies gebruiken om je ervaring te verbeteren. We doen dit op een transparante manier." />
        <meta name="author" content="E-notifyer" />
        <title>Cookie Policy - E-Notifyer - Jouw slimme e-mail oplossing</title>
    ...
    <body id="page-top">
        ...
        <header class="masthead text-center text-white">
            <div class="masthead-content">
                <div class="container px-5">
                    <h1 class="masthead-heading mb-0">Cookies Policy</h1>
                    <h2 class="masthead-subheading mb-0">Last updated: October 31, 2024</h2>
        ...
        <section id="scroll">
            <div class="container px-5">
                ...
                <ul>
                    <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Media 2 Connect B.V., Louis Couperusplein 2, 2514HP Den Haag, Nederland.</li>
                    <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                    <li><strong>Website</strong> refers to E-notifyer, accessible from <a href="https://e-notifyer.nl">e-notifyer.nl</a></li>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Functionality Cookies</strong></p><p>Type: Persistent Cookies</p><p>Administered by: Us</p><p>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
                    </li>
                </ul>
